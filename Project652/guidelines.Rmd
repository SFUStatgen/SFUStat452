...
The file `HUI.csv` contains 8 health-utility-index (HUI)
variables. This is a subset of the 13 variables described
on pages 45-54 of the file `CCHS_HA_Derived_variables.pdf`.
The first, `HUIDCOG` is a categorical variable
...
Use the other HUIs to predict `HUIDGOC`.
