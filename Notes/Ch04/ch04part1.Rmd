...
```{r}
ggplot(Default,aes(x=default,y=income)) + geom_boxplot()
```
...
```{r}
ggplot(Default,aes(x=balance,y=income,color=default)) + geom_density2d()
```
...
```{r}
ggplot(Default,aes(x=balance,y=income,color=interaction(default,student))) + 
  geom_density2d()
```
