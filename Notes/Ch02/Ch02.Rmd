...
\begin{center}
\includegraphics[height=2in]{Fig2_9.pdf}
\end{center}

\vspace*{-.3in}

* The black line is the curve used to simulate data (circles)
and the other lines are fitted curves of different flexibility
(smoothing splines, Chapter 7).

* In the right panel, the grey line is the training MSE
and the red is the test MSE.
    + The "U" shape of the test MSE is typical and 
    reflects the bias-variance trade-off
