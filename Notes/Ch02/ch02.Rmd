...
* We can argue that test MSE is composed of three quantities (next slide): (i) 
...
distribution of $X$. Equivalently, $Err$ is the average of 
the test errors over training datasets. (Order of averaging doesn't matter.)
