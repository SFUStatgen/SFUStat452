...
* Authors split Hitters into a 132 training and
131 test obs'ns.
* Applied CV to the training half to select $\alpha$,
or equivalently $|T|$.
...
or CV (green). Based on CV take $|T|=3$.
...
* Turns out classification error is not sensitive
