...
* We'd probably just use the least-squares
estimates and SEs:
    + Though we know model selection methods found
    a model with better MSE than the full model 
