...
* 10-fold CV estimates are slightly larger on average, which may reflect
the upward bias in the estimator..
* We'd expect the 10-fold CV estimator to have lower variance, but 
